 ...
 */
myApp.controller('daftarPetugasCtrl',function($rootScope,$scope,$http,$filter,$window){

    $http.get('public/models/petugas/getDaftarPetugas.php').
    ...
    $scope.hapusPetugas = function(ktp) {
        deleteUser = $window.confirm('Anda yakin ingin menghapus petugas?');
        if (deleteUser){
            $http.post('public/models/petugas/hapusPetugas.php',{ktp:ktp})
                .then(
                function(response){
                    $http.post('public/models/petugas/getDaftarPetugas.php').
                        then(function(response){
                            console.log('success');
                            $scope.laporan = response.data;
                        }, function(response){
