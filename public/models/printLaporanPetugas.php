 ...
 *
 */
$sql_query = "SELECT k.*, u.nama AS user, p.nama AS petugas FROM keluhan AS k, user AS u, (SELECT * FROM user WHERE status='petugas') AS p WHERE k.ktp_user = u.ktp AND k.ktp_petugas = p.ktp AND p.ktp = '$_GET[ktp]'";
if ($_GET['tgl'] != ''){
